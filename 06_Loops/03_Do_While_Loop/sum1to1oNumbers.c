...
Purpose: To print the sum of numbers from 1 to 10 using a do-while loop and also display the cumulative sum at each iteration.

Description:
- The program uses a do-while loop to iterate over the values from 1 to 10.
